...
export default function UsernameMenu() {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent>
        <DropdownMenuItem>
          <Link to="/user-profile" className="hover:text-orange-500 font-bold">User Profile</Link>
        </DropdownMenuItem>
        <Separator />
        <DropdownMenuItem>
          <Button onClick={() => logout()} className='text-orange-500 hover:text-orange-400 font-bold flex flex-1'>Log Out</Button>
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
